...
RUN cd root; wget http://d3kbcqa49mib13.cloudfront.net/spark-2.0.0-bin-hadoop2.6.tgz
RUN cd root; tar -xzf spark-2.0.0-bin-hadoop2.6.tgz
RUN cd root; ln -s spark--2.0.0-bin-hadoop2.6 spark
